        ...
        <header className="relative z-50 w-full">
            <div className="bg-gradient-to-r from-green-500 to-green-700 p-[1px]">
                <div className="relative bg-gradient-to-r from-black to-gray-900">
                    <div className="absolute top-0 left-0 w-8 h-8 bg-gradient-to-br from-green-400 to-green-600 transform rotate-45 -translate-x-4 -translate-y-4"></div> 
                    <div className="absolute top-0 right-0 w-8 h-8 bg-gradient-to-bl from-green-400 to-green-600 transform rotate-45 translate-x-4 -translate-y-4"></div> 
                    <div className="absolute bottom-0 left-0 w-8 h-8 bg-gradient-to-tr from-green-400 to-green-600 transform rotate-45 -translate-x-4 translate-y-4"></div> 
                    <div className="absolute bottom-0 right-0 w-8 h-8 bg-gradient-to-tl from-green-400 to-green-600 transform rotate-45 translate-x-4 translate-y-4"></div>
                    ...
                    <div className="flex items-center justify-between px-4 py-3 md:px-8 md:py-4 relative z-10">
                        ...
                        <Button
                            variant="ghost"
                            className="md:hidden text-green-400 hover:text-white text-2xl"
